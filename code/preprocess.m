...
trainList = collectData('C:\Users\Admin\Desktop\FaceVerification\TestingSpace\NNtest\Image\Database','Database');%collectData(fullfile(pwd, 'data/Data'), 'Data');
testList  = collectData('C:\Users\Admin\Desktop\FaceVerification\TestingSpace\NNtest\Image\ImIn','ImIn');%collectData(fullfile(pwd, 'data/Test1'), 'Test1');
%% caffe settings
% gpu = 1;
% if gpu
%    gpu_id = 0;
